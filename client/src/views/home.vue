<template>
  <div class="home-container container">
    <div class="return">
      <el-button type="info" @click="returnLogin">返回</el-button>
    </div>
    <div class="room-btn" v-show="showBtn">
      ...
      <div class="room-config" v-show="showGameconfig">
        ...
        <div class="room-config-body">
          ...
          <div class="btn" @click="recordSingleHand">
            <span>记录一手牌</span>
          </div>
        </div>
      </div>
      ...
      <!-- 记录 -->
      <!-- <div class="create-room btn" @click="preflopRangeTraining">
        <span>翻前范围训练</span>
      </div> -->
      <!-- 记录 -->
      <div class="create-room btn" @click="showGameconfig = true">
        <span>记录一手牌</span>
      </div>
      <!-- 下载 -->
      <div class="create-room btn" @click="downloadHands">
        <span>下载历史记录</span>
      </div>
    </div>
